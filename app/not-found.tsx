...
export const metadata: Metadata = {
  title: "404 — Page Not Found | DevProFlow",
    ...
    <main className="min-h-screen bg-black text-white flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#292d30] bg-[#0a0a0c] text-xs text-[#a1a4a5] mb-8 animate-fade-in">
          <span className="inline-block w-2 h-2 rounded-full bg-[#ff7a7a]" />
          <span className="font-mono-label">error.404</span>
        </div>

        <h1 className="text-6xl sm:text-8xl font-serif-display tracking-tight mb-4 text-[#fcfdff] animate-fade-up">
          4<span className="text-iris">0</span>4
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up" style={{ animationDelay: "0.2s" }}>
          <a href="/" className="btn-white-pill inline-flex items-center gap-2">
            Back to Home
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3" />
            </svg>
          </a>
          <a href="/products" className="btn-ghost inline-flex items-center gap-2">Browse Products</a>
        </div>
      </div>
    </main>
  );
