...
const products: Product[] = [
  ...
  },
  {
    id: "sport-center",
    name: "Sport Center",
    tagline: "B2B lead generation for sport centers",
    description:
      "Lead generation platform for sport centers. Find new customers, manage outreach, and stay ahead of competitors.",
    category: "Sports & B2B",
    tech: ["Lead Generation", "CRM", "Outreach", "Competitive Analysis"],
    features: [
      "B2B lead generation",
